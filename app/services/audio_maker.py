...
class YandexSpeechKitAudioMaker:
    ...
    def __init__(self):
        ...
        self.voice = os.getenv("YANDEX_VOICE", "alena")  # alena, filipp, ermil, jane, omazh
        self.emotion = os.getenv("YANDEX_EMOTION", "neutral")  # good, evil, neutral
        self.speed = float(os.getenv("YANDEX_SPEED", "1.0"))  # 0.1-3.0
        self.format = "mp3"  # lpcm, oggopus, mp3
        self.lang = os.getenv("YANDEX_LANG", "ru-RU")
    ...
    async def create_audio(self, text: str, voice: Optional[str] = None,
                           emotion: Optional[str] = None,
                           speed: Optional[float] = None,
                           lang: Optional[str] = None) -> tuple[bytes, float]:
